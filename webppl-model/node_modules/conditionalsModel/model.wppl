...
var priorSample = function(par){
  ...
  var alpha = par.includes("alpha") ? {alpha: sample(Exponential({a: 0.2}), {driftKernel: exponentialKernel})} : {};
  // var theta = par.includes("theta") ? {theta: sample(Beta({a: 2, b: 2}), {driftKernel: betaKernel})} : {};
  var theta = par.includes("theta") ? {theta: sample(Uniform({a: 0.5, b: 1}), {driftKernel: gaussianKernel})} : {};
